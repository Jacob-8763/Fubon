                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data">
                        <div class="mb-3" v-show="isShowInsertButton">
                            ...
                            <input class="form-control" type="text" name="id" :value="pet.id"
                                @input="doInput('id', $event)">
                        </div>
                        <div class="mb-3">
                            <label for="age" class="form-label">種類</label>
                            <input class="form-control" type="text" name="species" :value="pet.species"
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="status" :value="pet.status"
