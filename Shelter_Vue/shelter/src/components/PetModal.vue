        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="id" :value="pet.id" :readonly="!isShowInsert" required
                        ...
                        <div class="mb-3" v-show="!isShowInsert">
                ...
                <div class="modal-footer">
                    <!-- 顯示 "新增" 按鈕 -->
                    <button type="button" class="btn btn-primary" v-show="isShowInsert"
...
<script setup>
const props = defineProps(["pet", "isShowInsert"])
